...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
        @if (session('UserPermissionAdd'))
            <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h5><i class="icon fas fa-check"></i> Alert!</h5>
                {{ session('UserPermissionAdd') }}
            </div>
        @endif
        ...
        <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">{{ __('User Permission') }}</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('UserPermissionAdd') }}" method="POST">
                  @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <input name="permission[]" value="{{ $permission->name }}" class="form-check-input" type="checkbox">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-center">
                                      <a href="{{ route('UserPermissionEdit', $user->id) }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-edit"></i></a>
                                      <a href="{{ route('UserPermissionClean', $user->id) }}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>
                                  </td>
                                </tr>
                                @endforeach
                              </tbody>
