        ...
        <div class="col-md-10 mx-auto">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">{{ __('Create Blog Post') }}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="write blog title">
                            @error('title')
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="post" id="my-editor" cols="30" rows="20"></textarea>
                    </div>
                  </div>
                  <!-- /.card-body -->
